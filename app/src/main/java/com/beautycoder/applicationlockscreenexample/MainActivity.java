...
public class MainActivity extends AppCompatActivity {
    ...
    private void showLockScreenFragment(boolean isPinExist) {
        final PFFLockScreenConfiguration.Builder builder = new PFFLockScreenConfiguration.Builder(this)
                .setTitle(isPinExist ? "Nhập pascode" : "Tạo passcode")
                .setRequestTitle(isPinExist?"Vui lòng nhập passcode để bắt đầu sử dụng":"Vui lòng tạo passcode để bảo mật tốt hơn")
                .setCodeLength(6)
                .setLeftButton("Quên?")
